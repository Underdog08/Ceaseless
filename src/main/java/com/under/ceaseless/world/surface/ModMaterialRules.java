...
public class ModMaterialRules {
    ...
    private static final MaterialRules.MaterialRule END_WASTES_GROUND = makeStateRule(Blocks.END_STONE);
    private static final MaterialRules.MaterialRule END_WASTES_SURFACE = makeStateRule(ModBlocks.END_SAND);
    private static final MaterialRules.MaterialRule END_WASTES_SUBSURFACE = makeStateRule(ModBlocks.PACKED_END_SAND);
    ...
    public static MaterialRules.MaterialRule makeRules() {
        ...
        MaterialRules.MaterialRule end_wastes_subsurface = MaterialRules.sequence(MaterialRules.condition(isAtOrAboveWaterLevel, END_WASTES_SUBSURFACE));
        ...
        return MaterialRules.sequence(
                MaterialRules.sequence(
                        ...
                        MaterialRules.condition(MaterialRules.biome(ModBiomes.END_WASTES_HIGHLANDS), MaterialRules.condition(MaterialRules.stoneDepth(0, false, 0, VerticalSurfaceType.FLOOR), end_wastes_surface)),
                        MaterialRules.condition(MaterialRules.biome(ModBiomes.END_WASTES_HIGHLANDS), MaterialRules.condition(MaterialRules.stoneDepth(1, true, 1, VerticalSurfaceType.FLOOR), end_wastes_subsurface)),
                        ...
                        MaterialRules.condition(MaterialRules.biome(ModBiomes.END_WASTES_MIDLANDS), MaterialRules.condition(MaterialRules.stoneDepth(0, false, 0, VerticalSurfaceType.FLOOR), end_wastes_surface)),
                        MaterialRules.condition(MaterialRules.biome(ModBiomes.END_WASTES_MIDLANDS), MaterialRules.condition(MaterialRules.stoneDepth(1, true, 1, VerticalSurfaceType.FLOOR), end_wastes_subsurface)),
                        ...
                        MaterialRules.condition(MaterialRules.biome(ModBiomes.END_WASTES_EDGE), MaterialRules.condition(MaterialRules.stoneDepth(0, false, 0, VerticalSurfaceType.FLOOR), end_wastes_surface)),
                        MaterialRules.condition(MaterialRules.biome(ModBiomes.END_WASTES_EDGE), MaterialRules.condition(MaterialRules.stoneDepth(1, true, 1, VerticalSurfaceType.FLOOR), end_wastes_subsurface)),
